    ...
    function getAllEmployeesTable() {
        $.ajax({
            ...
            success: function(result) {
				...
				<div class="card-header bg-info text-white" data-toggle="modal" data-target="#addEmployeeModal">
                <h5>Employees
                <i class="fas fa-plus ml-2" id="empAddScreen"></i>
                </h5>
				</div>
    ...
    function getAllDepartmentTable() {
        $.ajax({
            ...
            success: function(result) {
                ...
                <h5 class="card-header bg-info text-white" data-toggle="modal" data-target="#addDepartmentModal">Department
...
function  getAllLocationTable() {
        $.ajax({
            ...
            success: function(result) {
                ...
                <h5 class="card-header bg-info text-white" data-toggle="modal" data-target="#addLocationModal">Location
                <i class="fas fa-plus ml-2"></i>
                </h5>
                <div class="card-body">
